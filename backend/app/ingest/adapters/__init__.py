...
# KI-Regio Mainfranken (project's own AI events page, static WordPress Cool-Timeline scrape)
from . import ki_regio  # noqa: F401  (import side-effect: registration)
# Startbahn27 Schweinfurt startup-ecosystem calendar (static TYPO3 month grid)
from . import startbahn27  # noqa: F401  (import side-effect: registration)
# Institut für Informatik, Uni Würzburg (own TYPO3 calendar, not in the central RSS — coverage gap)
from . import informatik_uni_wue  # noqa: F401  (import side-effect: registration)
